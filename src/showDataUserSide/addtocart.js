...
import {addtocartArray} from './showHome'
...
function Addtocart() {
    ...
    const mobileDatabaseRef = collection(database, "CART DATA");
                                        ...
                                        {show.map((item)=>{
                                           return(
                                            ...
                                            <div className="md:pl-3 md:w-3/4">
                                                <p className="text-xs leading-3 text-gray-800 md:pt-0 pt-4">{item.model}</p>
                                                ...
                                                <p className="text-xs leading-3 text-gray-600 pt-2">{item.size}</p>
                                                <p className="text-xs leading-3 text-gray-600 py-4">{item.detail}</p>
